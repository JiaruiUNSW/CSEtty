...
The data in an event gate counter arrives as a bounded integer array. A small, auditable metric is needed before the next processing stage.
...
**Exact rule.** Return the zero-based index of the first maximum, or -1 for an empty array.

Submit `c1511_array_012.c`. Your program must not print prompts or explanatory text.

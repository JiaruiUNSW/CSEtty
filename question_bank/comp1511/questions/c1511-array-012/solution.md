# First Busiest Gate — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for first busiest gate.
...
Scan the array while maintaining exactly the state needed for first busiest gate. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

# Longest Stable Voltage Run — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for longest stable voltage run.
...
Scan the array while maintaining exactly the state needed for longest stable voltage run. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

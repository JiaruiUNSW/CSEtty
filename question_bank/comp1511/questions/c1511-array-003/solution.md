# Even Platform Codes — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for even platform codes.
...
Scan the array while maintaining exactly the state needed for even platform codes. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

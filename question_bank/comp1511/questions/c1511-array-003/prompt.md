...
The data in a railway platform audit arrives as a bounded integer array. A small, auditable metric is needed before the next processing stage.
...
**Exact rule.** Count elements whose remainder modulo 2 is zero, including zero and negative evens.

Submit `c1511_array_003.c`. Your program must not print prompts or explanatory text.

# Repeated Tag Neighbours — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for repeated tag neighbours.
...
Scan the array while maintaining exactly the state needed for repeated tag neighbours. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
**Exact rule.** Return the maximum parenthesis nesting depth, or -1 if any prefix closes below zero or the final depth is nonzero.

Submit `c1511_text_008.c`. Your program must not print prompts or explanatory text.

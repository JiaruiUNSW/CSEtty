...
**Exact rule.** Ignore nonletters, then count transitions between uppercase and lowercase among consecutive remaining letters.

Submit `c1511_text_011.c`. Your program must not print prompts or explanatory text.

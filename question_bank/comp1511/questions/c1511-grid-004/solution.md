# Horizontal Mirror Mismatches — worked solution

## Idea in one sentence

Visit exactly the cells participating in horizontal mirror mismatches and maintain one scalar result.

## Exact rule

Count unequal horizontal mirror pairs, examining each pair only once.

## Approach

Visit exactly the cells participating in horizontal mirror mismatches and maintain one scalar result. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

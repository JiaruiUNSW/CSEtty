...
**Exact rule.** Count unequal horizontal mirror pairs, examining each pair only once.

Submit `c1511_grid_004.c`. Your program must not print prompts or explanatory text.

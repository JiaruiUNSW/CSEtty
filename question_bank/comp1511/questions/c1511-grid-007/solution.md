# Maximum Two-by-Two Load — worked solution

## Idea in one sentence

Visit exactly the cells participating in maximum two-by-two load and maintain one scalar result.
...
Visit exactly the cells participating in maximum two-by-two load and maintain one scalar result. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

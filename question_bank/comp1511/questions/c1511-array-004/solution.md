# Ridge Station Peaks — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for ridge station peaks.
...
Scan the array while maintaining exactly the state needed for ridge station peaks. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

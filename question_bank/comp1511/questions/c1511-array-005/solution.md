# River Gauge Valleys — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for river gauge valleys.
...
Scan the array while maintaining exactly the state needed for river gauge valleys. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

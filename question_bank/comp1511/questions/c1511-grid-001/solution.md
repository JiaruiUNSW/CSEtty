# Coastal Grid Border Total — worked solution

## Idea in one sentence

Visit exactly the cells participating in coastal grid border total and maintain one scalar result.
...
Visit exactly the cells participating in coastal grid border total and maintain one scalar result. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
**Exact rule.** Count maximal non-whitespace runs; any ASCII whitespace separates words.

Submit `c1511_text_003.c`. Your program must not print prompts or explanatory text.

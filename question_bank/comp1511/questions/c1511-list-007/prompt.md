...
**Exact rule.** Recursively return `head->value + total(head->next)`, with `total(NULL) = 0`.

Submit `c1511_list_007.c`. Your program must not print prompts or explanatory text.

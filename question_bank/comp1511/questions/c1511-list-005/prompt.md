...
**Exact rule.** Return the zero-based position of the first maximum node, or -1 for an empty list.

Submit `c1511_list_005.c`. Your program must not print prompts or explanatory text.

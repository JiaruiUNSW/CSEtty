...
**Exact rule.** Return 1 for a balanced parenthesis sequence and 0 otherwise; non-parenthesis characters are ignored.

Submit `c1511_text_009.c`. Your program must not print prompts or explanatory text.

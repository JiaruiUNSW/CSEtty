...
**Exact rule.** Count nodes containing an even integer, including zero and negative evens.

Submit `c1511_list_004.c`. Your program must not print prompts or explanatory text.

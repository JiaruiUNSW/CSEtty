...
**Exact rule.** Return the first row index with greatest row sum, or -1 if either dimension is zero.

Submit `c1511_grid_003.c`. Your program must not print prompts or explanatory text.

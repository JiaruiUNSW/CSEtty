# Largest Seismic Magnitude — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for largest seismic magnitude.
...
Scan the array while maintaining exactly the state needed for largest seismic magnitude. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

# Habitat Range Width — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for habitat range width.
...
Scan the array while maintaining exactly the state needed for habitat range width. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

# Four-Neighbour Terrain Peaks — worked solution

## Idea in one sentence

Visit exactly the cells participating in four-neighbour terrain peaks and maintain one scalar result.

## Exact rule

Count cells strictly greater than every existing orthogonal neighbour; a neighbourless cell does not count.

## Approach

Visit exactly the cells participating in four-neighbour terrain peaks and maintain one scalar result. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

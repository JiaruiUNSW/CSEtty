...
**Exact rule.** Return the longest contiguous run of equal node values, or 0 for an empty list.

Submit `c1511_list_006.c`. Your program must not print prompts or explanatory text.

...
The data in a laboratory pressure series arrives as a bounded integer array. A small, auditable metric is needed before the next processing stage.
...
**Exact rule.** Count adjacent pairs with one strictly negative and one strictly positive value; pairs containing zero do not count.

Submit `c1511_array_006.c`. Your program must not print prompts or explanatory text.

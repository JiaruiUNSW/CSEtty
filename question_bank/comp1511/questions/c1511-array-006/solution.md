# Pressure Sign Changes — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for pressure sign changes.
...
Scan the array while maintaining exactly the state needed for pressure sign changes. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

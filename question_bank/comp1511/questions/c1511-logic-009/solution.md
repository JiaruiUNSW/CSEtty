# Largest Pair Spread — worked solution

## Idea in one sentence

Compare the three values in a fixed order to compute largest pair spread.
...
Compare the three values in a fixed order to compute largest pair spread. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

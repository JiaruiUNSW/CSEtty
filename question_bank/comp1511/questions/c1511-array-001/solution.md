# Solar Surplus Total — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for solar surplus total.
...
Scan the array while maintaining exactly the state needed for solar surplus total. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
The data in a community battery log arrives as a bounded integer array. A small, auditable metric is needed before the next processing stage.
...
**Exact rule.** Sum only values strictly greater than zero; return 0 for an empty array.

Submit `c1511_array_001.c`. Your program must not print prompts or explanatory text.

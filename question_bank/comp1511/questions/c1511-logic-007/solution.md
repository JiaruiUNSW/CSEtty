# Three-Reading Order Code — worked solution

## Idea in one sentence

Compare the three values in a fixed order to compute three-reading order code.
...
Compare the three values in a fixed order to compute three-reading order code. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

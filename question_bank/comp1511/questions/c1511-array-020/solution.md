# Out-of-Order Seed Pairs — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for out-of-order seed pairs.
...
Scan the array while maintaining exactly the state needed for out-of-order seed pairs. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

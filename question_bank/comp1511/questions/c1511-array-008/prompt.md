...
The data in a building lift trace arrives as a bounded integer array. A small, auditable metric is needed before the next processing stage.
...
**Exact rule.** Count adjacent pairs where the later value is strictly greater than the earlier value.

Submit `c1511_array_008.c`. Your program must not print prompts or explanatory text.

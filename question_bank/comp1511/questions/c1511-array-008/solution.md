# Ascending Lift Segments — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for ascending lift segments.
...
Scan the array while maintaining exactly the state needed for ascending lift segments. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

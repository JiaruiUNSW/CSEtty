# Solvent-Safe Prefixes — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for solvent-safe prefixes.
...
Scan the array while maintaining exactly the state needed for solvent-safe prefixes. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
The data in a cumulative solvent ledger arrives as a bounded integer array. A small, auditable metric is needed before the next processing stage.
...
**Exact rule.** Count prefixes whose cumulative sum from index 0 is greater than or equal to zero.

Submit `c1511_array_017.c`. Your program must not print prompts or explanatory text.

# Freezer Alarm Count — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for freezer alarm count.
...
Scan the array while maintaining exactly the state needed for freezer alarm count. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

# Last Lowest Reservoir — worked solution

## Idea in one sentence

Scan the array while maintaining exactly the state needed for last lowest reservoir.
...
Scan the array while maintaining exactly the state needed for last lowest reservoir. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

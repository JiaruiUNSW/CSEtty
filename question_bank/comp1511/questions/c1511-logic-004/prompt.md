...
**Exact rule.** Return the largest absolute magnitude among the three signed inputs.

Submit `c1511_logic_004.c`. Your program must not print prompts or explanatory text.

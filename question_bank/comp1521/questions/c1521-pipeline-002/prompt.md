# Pipe-Transferred Positive Count
...
Submit `c1521_pipeline_002.c` only. Your program must not print prompts, labels, or explanatory text unless the required output format explicitly includes them.

...
**Exact rule.** Count real regular files whose basename ends exactly with the case-sensitive suffix `.c`.

Submit `c1521_tree_007.c`. Your program must not print prompts or explanatory text.

...
**Exact rule.** Treat every 1 bit in `y` as a bit to enable and return `x | y`; ignore `k`.

Submit `c1521_bits_004.c`. Your program must not print prompts or explanatory text.

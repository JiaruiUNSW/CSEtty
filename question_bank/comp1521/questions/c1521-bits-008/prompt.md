...
**Exact rule.** Let `s = k % 32`; rotate `x` right by `s` bits, wrapping shifted-out bits into the high end.

Submit `c1521_bits_008.c`. Your program must not print prompts or explanatory text.

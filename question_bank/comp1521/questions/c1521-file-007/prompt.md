...
**Exact rule.** Count bytes in the inclusive printable-ASCII range `0x20` through `0x7E`.

Submit `c1521_file_007.c`. Your program must not print prompts or explanatory text.

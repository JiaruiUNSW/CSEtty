...
**Exact rule.** Interpret only the IEEE-754 binary32 exponent and fraction fields of `x`: return 0 for zero, 1 for subnormal, 2 for finite normal, 3 for infinity, and 4 for NaN.

Submit `c1521_bits_018.c`. Your program must not print prompts or explanatory text.

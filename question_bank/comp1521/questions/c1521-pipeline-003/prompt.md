...
**Exact rule.** Count input elements divisible by two, including zero and negative even values.

Submit `c1521_pipeline_003.c`. Your program must not print prompts or explanatory text.

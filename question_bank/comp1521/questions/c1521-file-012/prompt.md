...
**Exact rule.** Return the zero-based offset of the last `0x0A` byte, or -1 if none exists.

Submit `c1521_file_012.c`. Your program must not print prompts or explanatory text.

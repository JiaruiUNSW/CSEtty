# MIPS Positive Reading Count — worked solution

## Idea in one sentence

Translate the loop invariant for mips positive reading count into a leaf MIPS function.
...
Translate the loop invariant for mips positive reading count into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
**Exact rule.** Count elements strictly greater than zero; zero does not count.

Submit `c1521_mips_002.s`. Your program must not print prompts or explanatory text.

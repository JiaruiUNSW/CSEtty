# Encode a Compact MIPS I-Format Word — worked solution

## Idea in one sentence

Use masks and unsigned shifts to implement encode a compact mips i-format word without string conversion.
...
Use masks and unsigned shifts to implement encode a compact mips i-format word without string conversion. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

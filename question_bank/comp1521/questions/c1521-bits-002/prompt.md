...
**Exact rule.** Return bits 31 through 24 of `x` as an unsigned value from 0 to 255; ignore `y` and `k`.

Submit `c1521_bits_002.c`. Your program must not print prompts or explanatory text.

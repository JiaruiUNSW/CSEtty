# MIPS XOR Buffer Fold — worked solution

## Idea in one sentence

Translate the loop invariant for mips xor buffer fold into a leaf MIPS function.

## Exact rule

Bitwise-XOR all 32-bit element patterns from left to right, starting from zero.

## Approach

Translate the loop invariant for mips xor buffer fold into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
**Exact rule.** Bitwise-XOR all 32-bit element patterns from left to right, starting from zero.

Submit `c1521_mips_008.s`. Your program must not print prompts or explanatory text.

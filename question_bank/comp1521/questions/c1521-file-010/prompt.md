...
**Exact rule.** Return the longest contiguous run of identical bytes, or 0 for an empty file.

Submit `c1521_file_010.c`. Your program must not print prompts or explanatory text.

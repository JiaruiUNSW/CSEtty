...
**Exact rule.** Return the sum of the absolute values of all input elements.

Submit `c1521_pipeline_004.c`. Your program must not print prompts or explanatory text.

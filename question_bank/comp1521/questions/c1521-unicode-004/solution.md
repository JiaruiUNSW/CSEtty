# UTF-8 Leading Byte — worked solution

## Idea in one sentence

Classify the scalar range first, then derive utf-8 leading byte from the UTF-8/UTF-16 boundary table.

## Exact rule

Return the unsigned value of the first byte in the canonical UTF-8 encoding, or -1 for a non-scalar.

## Approach

Classify the scalar range first, then derive utf-8 leading byte from the UTF-8/UTF-16 boundary table. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
**Exact rule.** Return the unsigned value of the first byte in the canonical UTF-8 encoding, or -1 for a non-scalar.

Submit `c1521_unicode_004.c`. Your program must not print prompts or explanatory text.

# MIPS Absolute Buffer Total — worked solution

## Idea in one sentence

Translate the loop invariant for mips absolute buffer total into a leaf MIPS function.
...
Translate the loop invariant for mips absolute buffer total into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

...
**Exact rule.** Let `s = k % 32`; return the low five bits of the logical right shift `x >> s`.

Submit `c1521_bits_014.c`. Your program must not print prompts or explanatory text.

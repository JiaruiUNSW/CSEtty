# Extract a Five-Bit Register Field — worked solution

## Idea in one sentence

Use masks and unsigned shifts to implement extract a five-bit register field without string conversion.
...
Use masks and unsigned shifts to implement extract a five-bit register field without string conversion. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

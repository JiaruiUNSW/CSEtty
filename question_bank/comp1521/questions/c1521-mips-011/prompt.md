...
**Exact rule.** Return the zero-based index of the first greatest element, or -1 for an empty array.

Submit `c1521_mips_011.s`. Your program must not print prompts or explanatory text.

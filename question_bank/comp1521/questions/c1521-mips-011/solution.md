# MIPS First Maximum Index Function — worked solution

## Idea in one sentence

Translate the loop invariant for mips first maximum index function into a leaf MIPS function.

## Exact rule

Return the zero-based index of the first greatest element, or -1 for an empty array.

## Approach

Translate the loop invariant for mips first maximum index function into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

# MIPS Nonzero Channel Count — worked solution

## Idea in one sentence

Translate the loop invariant for mips nonzero channel count into a leaf MIPS function.

## Exact rule

Count elements that are not equal to zero.

## Approach

Translate the loop invariant for mips nonzero channel count into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

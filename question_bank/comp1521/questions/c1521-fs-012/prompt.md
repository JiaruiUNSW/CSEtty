...
- Write `c1521_fs_012.c`.
- Decode the hexadecimal byte-string argument as strict UTF-8.
- On success print `one=A two=B three=C four=D`, counting canonical sequences of each width.
- On failure print `invalid O` for the failed sequence lead offset.
- Bad hex or arguments prints `c1521_fs_012: error\n` to standard error and returns 1.

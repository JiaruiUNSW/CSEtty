# MIPS Maximum Buffer Value — worked solution

## Idea in one sentence

Translate the loop invariant for mips maximum buffer value into a leaf MIPS function.

## Exact rule

Return the greatest element, or 0 for an empty array.

## Approach

Translate the loop invariant for mips maximum buffer value into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

# MIPS Alternating Register Total — worked solution

## Idea in one sentence

Translate the loop invariant for mips alternating register total into a leaf MIPS function.

## Exact rule

Compute `a[0] - a[1] + a[2] - a[3] + ...`, or 0 for an empty array.

## Approach

Translate the loop invariant for mips alternating register total into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

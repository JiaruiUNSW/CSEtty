...
**Exact rule.** Count bytes equal to hexadecimal `00`; embedded zero bytes are ordinary data.

Submit `c1521_file_003.c`. Your program must not print prompts or explanatory text.

...
**Exact rule.** Return 1 UTF-16 code unit for a scalar at or below `0xFFFF`, 2 units above it, and -1 for a non-scalar.

Submit `c1521_unicode_006.c`. Your program must not print prompts or explanatory text.

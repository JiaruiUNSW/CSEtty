...
**Exact rule.** Count elements divisible by two, including zero and negative even values.

Submit `c1521_mips_003.s`. Your program must not print prompts or explanatory text.

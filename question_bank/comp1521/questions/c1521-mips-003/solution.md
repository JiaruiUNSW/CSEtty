# MIPS Even Sample Count — worked solution

## Idea in one sentence

Translate the loop invariant for mips even sample count into a leaf MIPS function.

## Exact rule

Count elements divisible by two, including zero and negative even values.

## Approach

Translate the loop invariant for mips even sample count into a leaf MIPS function. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

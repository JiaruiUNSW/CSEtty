# Sign-Extend an Eight-Bit Reading — worked solution

## Idea in one sentence

Use masks and unsigned shifts to implement sign-extend an eight-bit reading without string conversion.
...
Use masks and unsigned shifts to implement sign-extend an eight-bit reading without string conversion. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

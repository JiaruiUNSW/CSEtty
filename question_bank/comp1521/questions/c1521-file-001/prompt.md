...
**Exact rule.** Return the exact number of bytes in the file; an empty file has size 0.

Submit `c1521_file_001.c`. Your program must not print prompts or explanatory text.

# Largest Recursive File Size — worked solution

## Idea in one sentence

Use depth-first traversal and merge each entry into a summary for largest recursive file size.
...
Use depth-first traversal and merge each entry into a summary for largest recursive file size. Keep the input, state update, and output-formatting phases separate so each can be checked independently.

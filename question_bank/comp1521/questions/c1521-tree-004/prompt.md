...
**Exact rule.** Count real regular files whose basename ends exactly with the case-sensitive suffix `.txt`.

Submit `c1521_tree_004.c`. Your program must not print prompts or explanatory text.

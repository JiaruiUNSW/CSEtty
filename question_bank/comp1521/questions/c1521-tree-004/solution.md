# Recursive Text File Count — worked solution

## Idea in one sentence

Use depth-first traversal and merge each entry into a summary for recursive text file count.
...
Use depth-first traversal and merge each entry into a summary for recursive text file count. Keep the input, state update, and output-formatting phases separate so each can be checked independently.
